mkdir -p /App/goodvotex/static/external/
...
if [ $? -eq 0 ]; then
  ...
  mv bootstrap.min.css /App/goodvotex/static/external/
else
...
if [ $? -eq 0 ]; then
  ...
  mv bootstrap.bundle.min.js /App/goodvotex/static/external/
else
...
if [ $? -eq 0 ]; then
    ...
    mv jquery-3.7.0.min.js /App/goodvotex/static/external/
else
